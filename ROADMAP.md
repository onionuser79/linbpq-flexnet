...
## Current state: v2.1.25 in production
...
**Production node IW2OHX-13 and test bed IR2UFV both run v2.1.25.**
...
_Document version: 2026-05-28 — v2.1.25 in production (both IW2OHX-13
