# LinBPQ FlexNet Integration (v2.1.18)
...
- `PC/Flexnet` over AXUDP — verified fully working against
  ...
  is closed in **v2.1.18** by rate-limiting outbound CE link-time
...
```
BPQBOL:IW2OHX-13} Version 6.0.25.28 (64 bit) and FlexNet v2.1.18
```
...
`FlexNet v2.1.18`) so you can confirm what's running.
