# LinBPQ FlexNet Integration (v2.1.23)
...
- `PC/Flexnet` over AXUDP — verified fully working against
  ...
  is closed in **v2.1.23** by rate-limiting outbound CE link-time
...
```
BPQBOL:IW2OHX-13} Version 6.0.25.28 (64 bit) and FlexNet v2.1.23
```
...
`FlexNet v2.1.23`) so you can confirm what's running.
